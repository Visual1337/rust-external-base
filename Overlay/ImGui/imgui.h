...
namespace ImGui
{
    ...
    IMGUI_API void          AmplitudeStyle(ImGuiStyle* dst = NULL);    // new, recommended style (default)
    ...
    IMGUI_API bool          KeyBind(const char* id, const ImVec2& size_arg, int& current_key, bool& find_key);
    IMGUI_API bool          TabButton(const char* label, const ImVec2& size = ImVec2(0, 0), int tab_button_id = 0, int current_tab = -1, ImFont* icon_font = NULL, const char* icon = "");   // custom tab button
    ...
    IMGUI_API bool          Checkbox2(const char* label, bool* v);//custom
    ...
    IMGUI_API bool          SliderFloatCustom(const char* label, float* v, float v_min, float v_max, const char* format = "%.3f", ImGuiSliderFlags flags = 0);
    ...
    IMGUI_API bool          SliderScalarCustom(const char* label, ImGuiDataType data_type, int current, void* p_data, const void* p_min, const void* p_max, const char* format = NULL, ImGuiSliderFlags flags = 0);
    ...
    IMGUI_API void          ColorPicker(const char* label, ImColor* pColor, ImGuiColorEditFlags flags = 0);
