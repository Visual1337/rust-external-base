...
//#endif
    ...
    IMGUI_API bool          KeyBindButtonEx(const char* iid, const char* label, const ImVec2& size_arg = ImVec2(0, 0), ImGuiButtonFlags flags = 0);
    IMGUI_API bool          TabButtonEx(const char* label, const ImVec2& size_arg, ImGuiButtonFlags flags, int tab_button_id, int current_tab, ImFont* icon_font, const char* icon);
